...
import { Grid, Checkbox, TextField, FormControlLabel, FormControl, Typography, makeStyles, InputLabel, Select, MenuItem } from '@material-ui/core';
...
export const Settings = ({ settings, setSettings }) => {
    ...
    return (
        <Grid item container justify='space-around' spacing={2} className={classes.root}>
            <Grid item lg={12}>
